...
INSERT INTO "new_SupportSettings" ("brandName", "closingPhrase", "customerGreetingStyle", "language", "shareTrackingNumber", "shop", "signatureName", "tone", "updatedAt") SELECT "brandName", "closingPhrase", "customerGreetingStyle", "language", "shareTrackingNumber", "shop", "signatureName", "tone", "updatedAt" FROM "SupportSettings";
